 ...
 *
 * @note    This function prepares a list item so that it can be added to a
 *list.
 *
...
static inline List *ListTail(List *p_list) {
  ...
  if (p_list->p_next == nullptr) {
    return (nullptr);
  }

  for (l = p_list; l->p_next != nullptr; l = l->p_next) {
    /* make lint happy */
  }
...
static inline int ListEmpty(const List *p_list) {
  ...
  return (((p_list->p_next == nullptr) ? 1 : 0));
}
 ...
 * @retval  nullptr    no element matches
 *
 ******************************************************************************/
typedef int (*pSearchFunc)(List *, void *key);

static inline List *ListSearch(List *p_list,
                               std::function<int(List *, void *key)> func,
                               void *key) {
  List *l;
 ...
 *
 ******************************************************************************/
static inline int ListGetIdxByItem(List *p_list,
                                   std::function<int(List *, void *key)> func,
                                   void *key) {
  List *l;
  int cnt = 0;
 ...
 *
 ******************************************************************************/
static inline List *ListRemoveItem(List *p_list,
                                   std::function<int(List *, void *key)> func,
                                   void *key) {
  List *l, *pre_l;
