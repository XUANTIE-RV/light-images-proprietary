...
enum e3aRuntimeSetData_t {
	THEAD_RUNTIME_SET_FACE_ROI = 0,
	THEAD_RUNTIME_SET_AEC_INPUT_INFO,
	THEAD_RUNTIME_SET_AWB_INPUT_INFO,
	THEAD_RUNTIME_SET_MAX,
};
