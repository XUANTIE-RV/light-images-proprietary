...
#ifndef __CAMERIC_ISP_STITCHING_EXP_DRV_API_H__
#define __CAMERIC_ISP_STITCHING_EXP_DRV_API_H__
...
extern RESULT CamerIcIspStitchingExpRegisterEventCb
(
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspStitchingExpDeRegisterEventCb
(
    CamerIcDrvHandle_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspStitchingExpEnable
(
    CamerIcDrvHandle_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspStitchingExpDisable
(
    CamerIcDrvHandle_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspStitchingExpIsEnabled
(
    CamerIcDrvHandle_t      handle,
    bool_t                  *pIsEnabled
);
 ...
 *
 *****************************************************************************/
RESULT CamerIcIspStitchingExpSetMeasuringMode
(
    CamerIcDrvHandle_t                  handle,
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspStitchingExpSetMeasuringWindow
(
    CamerIcDrvHandle_t  handle,
    const uint16_t      x,
    const uint16_t      y,
...
RESULT CamerIcIspStitchingStop
(
    CamerIcDrvHandle_t handle
);
