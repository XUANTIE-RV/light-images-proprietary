...
RESULT CamerIcIspExpV2SetSizeRatio
(
    CamerIcDrvHandle_t handle,
    float ratio
);

RESULT CamerIcIspExpV2InputSel
(
    CamerIcDrvHandle_t  handle,
    CamerIcIspExpV2Sel_t             input_select
);
#ifdef __cplusplus
}
#endif
