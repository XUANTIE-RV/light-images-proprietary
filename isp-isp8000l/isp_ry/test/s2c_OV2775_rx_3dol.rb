...
[
  ...
  [ 0x6c, 0x3003, 0x01 ],
  [ 0x6c, 0x3004, 0x05 ],
  [ 0x6c, 0x3005, 0x14 ], #change sensor output clock from 51MHz to 33MHz for gen6 platform
  [ 0x6c, 0x3006, 0x00 ],
  [ 0x6c, 0x3007, 0x07 ],
  [ 0x6c, 0x3008, 0x01 ],
  [ 0x6c, 0x3009, 0x00 ],
  ...
  [ 0x6c, 0x30b0, 0x13 ],
  [ 0x6c, 0x30b1, 0x99 ],
  [ 0x6c, 0x30b2, 0x06 ], #vblank should set 0x680 for 33MH, else the short vsync id cannot output
  [ 0x6c, 0x30b3, 0x80 ], #
  [ 0x6c, 0x30b6, 0x03 ],
  [ 0x6c, 0x30b7, 0x22 ],
  [ 0x6c, 0x30b8, 0x00 ],
  ...
  [ 0x6c, 0x315e, 0x01 ],
  [ 0x6c, 0x315f, 0x80 ],
  [ 0x6c, 0x3250, 0x35 ], #close sensor awb function
  [ 0x6c, 0x3012, 0x00 ]
  ...
  #puts "./i2c_write.rb 1 0x%02x 0x%02x 0x%02x" % [i2c_reg_item[0], i2c_reg_item[1], i2c_reg_item[2]]
end
