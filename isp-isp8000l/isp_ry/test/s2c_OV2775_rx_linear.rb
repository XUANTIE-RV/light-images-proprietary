...
[
  ...
  [0x6c, 0x3003, 0x01 ],
  [0x6c, 0x3004, 0x05 ],
  [0x6c, 0x3005, 0x26 ], #change sensor output clock from 51MHz to 60MHz
  [0x6c, 0x3006, 0x00 ],
  [0x6c, 0x3007, 0x07 ],
  [0x6c, 0x3008, 0x01 ],
  [0x6c, 0x3009, 0x00 ],
  ...
  [0x6c, 0x30bb, 0x40 ],
  #[0x6c, 0x3250, 0xf7 ],
  [0x6c, 0x3250, 0x35 ], #modified by fuwei, close internal-dpc/awb of sensor
  [0x6c, 0x30a8, 0x00 ],
  [0x6c, 0x30a9, 0x04 ], # output, offset, h
  [0x6c, 0x30aa, 0x00 ],
  [0x6c, 0x30ab, 0x04 ], # output, offset, v
  [0x6c, 0x30ac, 0x07 ], # output, size, h
  [0x6c, 0x30ad, 0x80 ],
  [0x6c, 0x30ae, 0x04 ], # output, size, v
  [0x6c, 0x30af, 0x38 ],
  #[0x6c, 0x30c0, 0x09 ], #rotation for correct size for demo show
  [0x6c, 0x30c0, 0x00 ], #modified by fuwei, not do rotation
  [0x6c, 0x30a9, 0x04 ],
  [0x6c, 0x3012, 0x01 ]
