...
#include <cameric_drv/cameric_isp_cac_drv_ry_api.h>
#include <cameric_drv/cameric_isp_dmsc2_drv_ry_api.h>
#include <cameric_drv/cameric_isp_green_equilibration_drv_ry_api.h>
...
struct CalibAe : Element {
    ...
    struct Ecm {
        CamEngineFlickerPeriod_ry_t flickerPeriod = CAM_ENGINE_FLICKER_100HZ_RY;
...
struct CalibCac : Element {
    ...
    struct Config {
        CamerIcIspCacConfig_ry_t config;
    };
...
struct CalibPaths : Element {
    ...
    void pathComposeSubElements(XMLElement &element, CamEnginePathConfig_ry_t &config);

    void pathParseSubElements(XMLElement &element, CamEnginePathConfig_ry_t &config);

    void reset();

    struct Config {
        CamEnginePathConfig_ry_t config[CAMERIC_MI_PATH_MAX_RY];
    } config;
};
...
struct CalibDmsc2 : Element {
    ...
    struct Config {
        CamericIspDemosaicContext_ry_t config;
    };
...
struct CalibRgbGamma : Element {
    ...
    struct Config {
        CamerIcIspRgbGammaContext_ry_t config;
    };
...
struct CalibTdnr : Element {
    ...
    struct Config {
        CamerIcIspTdnr3Config_ry_t config;
        double mode_a;
        double mode_b;
    };
...
struct CalibAehdrAutoRatio : Element {
    ...
    struct Config {
        ...
        CamEngineHdrConfig_ry_t config;
    };
