...
#include "cam_engine_interface_ry.hpp"
#include "cam_sensor_ry.hpp"
#include <vector>
...
struct Operation : CamStatus {
  ...
  std::string softwareVersion() const;
    ...
    // device operations
    static void bufferCb(CamEnginePathType_ry_t path, MediaBuffer_t *pMediaBuffer, void *pCtx);
    ...
    int updateMetadata(CamEnginePathType_ry_t path);
