...
#ifndef __CAMERIC_ISP_AFM_DRV_RY_API_H__
#define __CAMERIC_ISP_AFM_DRV_RY_API_H__

/**
 * @file    cameric_isp_afm_drv_ry_api.h
 *
...
#include <cameric_drv/cameric_isp_afm_drv_ry_api.h>
...
/******************************************************************************/
/**
 * @struct  CamerIcAfmMeasuringResult_ry_s
 *
 * @brief   A structure to represent a complete set of measuring values.
 *
 *****************************************************************************/
typedef struct CamerIcAfmMeasuringResult_ry_s
{
    ...
    uint32_t    PixelCntB;
    uint32_t    PixelCntC;
} CamerIcAfmMeasuringResult_ry_t;



/******************************************************************************/
/**
 * @enum    CamerIcIspAfmWindowId_ry_e
 *
 * @brief   Enumeration type to identify the Autofocus measuring window.
 *
 *****************************************************************************/
typedef enum CamerIcIspAfmWindowId_ry_e
{
 ...
 *          an error situation (i.e. please also @see CamerIcEventId_ry_e).
 *
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAfmRegisterEventCb_ry
(
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAfmDeRegisterEventCb_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAfmEnable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAfmDisable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAfmIsEnabled_ry
(
    CamerIcDrvHandle_ry_t      handle,
    bool_t                  *pIsEnabled
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAfmSetThreshold_ry
(
    CamerIcDrvHandle_ry_t  handle,
 ...
 *
 * @param   handle              CamerIc driver handle
 * @param   WdwId               window identifier (@see CamerIcIspAfmWindowId_ry_e)
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAfmSetMeasuringWindow_ry
(
    CamerIcDrvHandle_ry_t              handle,
    const CamerIcIspAfmWindowId_ry_t   WdwId,
    const uint16_t                  x,
    const uint16_t                  y,
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAfmEnableMeasuringWindow_ry
(
    CamerIcDrvHandle_ry_t              handle,
    const CamerIcIspAfmWindowId_ry_t   WdwId
);
 ...
 *
 *****************************************************************************/
extern bool_t CamerIcIspAfmMeasuringWindowIsEnabled_ry
(
    CamerIcDrvHandle_ry_t              handle,
    const CamerIcIspAfmWindowId_ry_t   WdwId
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAfmDisableMeasuringWindow_ry
(
    CamerIcDrvHandle_ry_t              handle,
    const CamerIcIspAfmWindowId_ry_t   WdwId
);
...
#endif /* __CAMERIC_ISP_AFM_DRV_RY_API_H__ */
