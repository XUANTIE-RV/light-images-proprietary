...
#ifndef __CAMERIC_IE_DRV_RY_API_H__
#define __CAMERIC_IE_DRV_RY_API_H__

/**
 * @cond    cameric_ie
 *
 * @file    cameric_ie_drv_ry_api.h
 *
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIeEnable_ry
(
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIeDisable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIeIsEnabled_ry
(
    CamerIcDrvHandle_ry_t      handle,
    bool_t                  *pIsEnabled
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIeConfigure_ry
(
    CamerIcDrvHandle_ry_t      handle,
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIeSetTintCb_ry
(
    CamerIcDrvHandle_ry_t      handle,
    const uint8_t           tint
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIeSetTintCr_ry
(
    CamerIcDrvHandle_ry_t      handle,
    const uint8_t           tint
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIeSetColorSelection_ry
(
    CamerIcDrvHandle_ry_t              handle,
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIeSetSharpen_ry
(
    CamerIcDrvHandle_ry_t              handle,
...
#endif /* __CAMERIC_IE_DRV_RY_API_H__ */
