...
#ifndef __CAMERIC_ISP_DMSC2_DRV_RY_API_H__
#define __CAMERIC_ISP_DMSC2_DRV_RY_API_H__
 ...
 *
 *****************************************************************************/
 typedef struct CamericIspDmscIntp_ry_t {
     uint16_t intp_dir_thr_min;
     uint16_t intp_dir_thr_max;
}CamericIspDmscIntp_ry_t;
typedef struct CamericIspDmscDemoire_ry_t {
    bool enabled;
...
}CamericIspDmscDemoire_ry_t;

typedef struct CamericIspDmscSharpen_ry_t {
    bool enabled;
    ...
    uint16_t sharpen_r2;
    uint16_t sharpen_r1;
} CamericIspDmscSharpen_ry_t;

typedef struct CamericIspDmscSharpenLine_ry_t {
	bool enabled;
...
} CamericIspDmscSharpenLine_ry_t;

typedef struct CamericIspDmscGFilter_ry_t {
    ...
    uint8_t hf_filt_21;
    uint8_t hf_filt_22;
} CamericIspDmscGFilter_ry_t;

typedef struct CamericIspDmscSkin_ry_t {
    bool enabled;
...
} CamericIspDmscSkin_ry_t;

typedef struct CamericIspDmscDepurple_ry_t {
    bool enabled;
    bool red_sat, blue_sat;
    uint8_t depurple_sat_shrink;
    uint8_t depurple_thr;
} CamericIspDmscDepurple_ry_t;

typedef struct CamericIspDmscCac_ry_t {
    bool cac_enable;
    ...
    uint8_t y_ns;
    uint8_t y_nf;
}CamericIspDmscCac_ry_t;
typedef struct CamericIspDemosaicContext_ry {
    bool enable;
    uint8_t demosaic_thr;
    uint8_t denoise_stren;
    CamericIspDmscIntp_ry_t intp;
    CamericIspDmscDemoire_ry_t demoire;
    CamericIspDmscSharpen_ry_t sharpen;
    CamericIspDmscGFilter_ry_t gFilter;
    CamericIspDmscSharpenLine_ry_t sharpenLine;
    CamericIspDmscSkin_ry_t skin;
    CamericIspDmscDepurple_ry_t depurple;
} CamericIspDemosaicContext_ry_t;

typedef struct CamericIspDmscSharpen2_ry_t {
    CamericIspDmscSharpen_ry_t sharpen;
    uint32_t gdenoise;
    uint32_t gsharpenSize;
} CamericIspDmscSharpen2_ry_t;

extern RESULT CamerIcIspDmscEnable_ry
(
    CamerIcDrvHandle_ry_t handle
);

extern RESULT CamerIcIspDmscDisable_ry
(
    CamerIcDrvHandle_ry_t handle
);
extern RESULT CamerIcIspDmscEnableDemoire_ry(CamerIcDrvHandle_ry_t handle);
extern RESULT CamerIcIspDmscDisableDemoire_ry(CamerIcDrvHandle_ry_t handle);

extern RESULT CamerIcIspDmscGetDemoire_ry
(
    CamerIcDrvHandle_ry_t  handle,
    CamericIspDmscDemoire_ry_t *pDemoircCfg
);

extern RESULT CamerIcIspDmscCfgDemoire_ry
(
    CamerIcDrvHandle_ry_t  handle,
    CamericIspDmscDemoire_ry_t *pDemoircCfg
);

extern RESULT CamerIcIspDmscEnableSharpen_ry(CamerIcDrvHandle_ry_t handle);
extern RESULT CamerIcIspDmscDisableSharpen_ry(CamerIcDrvHandle_ry_t handle);

extern RESULT CamerIcIspDmscGetSharpen_ry(CamerIcDrvHandle_ry_t handle, CamericIspDmscSharpen_ry_t *pSharpenCfg);

extern RESULT CamerIcIspDmscCfgSharpen_ry(CamerIcDrvHandle_ry_t handle, CamericIspDmscSharpen_ry_t *pSharpenCfg);

extern RESULT CamerIcIspDmscCfgSkin_ry
(
    CamerIcDrvHandle_ry_t  handle,
    CamericIspDmscSkin_ry_t *pSkinCfg
);

extern RESULT CamerIcIspDmscGetSkin_ry
(
    CamerIcDrvHandle_ry_t  handle,
    CamericIspDmscSkin_ry_t *pSkinCfg
);

RESULT CamerIcIspDmscSet_ry
(
    CamerIcDrvHandle_ry_t  handle,
    CamericIspDemosaicContext_ry_t *pDmsc
);

RESULT CamerIcIspGetDmsc_ry
(
    CamerIcDrvHandle_ry_t          handle,
...
RESULT CamerIcIspDmscUpdateAllSettings_ry
(
    CamerIcDrvHandle_ry_t  handle,
    CamericIspDemosaicContext_ry_t *pDmsc
);

RESULT CamerIcIspDmscGetAllSettings_ry
(
    CamerIcDrvHandle_ry_t  handle,
    CamericIspDemosaicContext_ry_t *pDmsc
);

RESULT CamericIspDmscSharpenEnable_ry
(
    CamerIcDrvHandle_ry_t  handle
);


RESULT CamericIspDmscSharpenDisable_ry
(
    CamerIcDrvHandle_ry_t  handle
);

RESULT CamericIspDmscSharpenConfig_ry
(
    CamerIcDrvHandle_ry_t  handle,
    CamericIspDmscSharpen2_ry_t *pConfig
);

RESULT CamerIcIspDmscSetInterplation_ry
(
    CamerIcDrvHandle_ry_t                  handle,
    uint16_t max,
    uint16_t min
...
RESULT CamerIcIspDmscCfgGfilter_ry
(
    CamerIcDrvHandle_ry_t handle,
    CamericIspDmscGFilter_ry_t *pGfilter
);

RESULT CamerIcIspDmscGetGfilter_ry(
    CamerIcDrvHandle_ry_t handle,
    CamericIspDmscGFilter_ry_t *pGfilter
) ;

RESULT CamerIcIspDmscCfgSharpenLine_ry
(
    CamerIcDrvHandle_ry_t handle, 
    CamericIspDmscSharpenLine_ry_t *pSharpenLine
);

RESULT CamerIcIspDmscGetSharpenLine_ry
(
    CamerIcDrvHandle_ry_t handle,
    CamericIspDmscSharpenLine_ry_t *pSharpenLine
);
...
#endif /* __CAMERIC_ISP_DMSC2_DRV_RY_API_H__ */
