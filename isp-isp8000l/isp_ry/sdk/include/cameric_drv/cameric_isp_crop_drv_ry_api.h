...
#ifndef __CAMERIC_ISP_CROP_DRV_RY_API_H__
#define __CAMERIC_ISP_CROP_DRV_RY_API_H__
...
typedef struct CamericIspCropContext_ry_s
{
    /* data */
    CamerIcWindow_ry_t  outWin;
    bool                enabled;
    uint32_t            inputWidth;
    uint32_t            inputHeight;
    uint8_t             pathId;
}CamericIspCropContext_ry_t;
 ...
 *
 *****************************************************************************/
RESULT CamerIcIspCropRelease_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspEnableCrop_ry
(
    CamerIcDrvHandle_ry_t handle,
    uint8_t pathId
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspDisableCrop_ry
(
    CamerIcDrvHandle_ry_t handle,
    uint8_t             pathId
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspIsCropEnabled_ry
(
    CamerIcDrvHandle_ry_t      handle,
    uint8_t                 pathId,
    bool_t                  *pIsEnabled
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspConfigCrop_ry
(
    CamerIcDrvHandle_ry_t  handle,
    CamericIspCropContext_ry_t    *pCrop
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspGetCropOutputWindow_ry
(
    CamerIcDrvHandle_ry_t  handle,
    uint8_t            pathId,
...
#endif /* __CAMERIC_ISP_CROP_DRV__RY_API_H__ */
