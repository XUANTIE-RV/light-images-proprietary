...
/**
 * @file cameric_isp_flt_drv_ry_api.h
 *
 * @brief
...
#ifndef __CAMERIC_ISP_FLT_DRV_RY_API_H__
#define __CAMERIC_ISP_FLT_DRV_RY_API_H__
 ...
 *
 */
typedef enum CamerIcIspFltDeNoiseLevel_ry_e
{
...
} CamerIcIspFltDeNoiseLevel_ry_t;
 ...
 *
 */
typedef enum CamerIcIspFltSharpeningLevel_ry_e
{
...
} CamerIcIspFltSharpeningLevel_ry_t;
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspFltEnable_ry
(
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspFltDisable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspFltIsEnabled_ry
(
    CamerIcDrvHandle_ry_t      handle,
    bool_t                  *pIsEnabled
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspFltGetFilterParameter_ry
(
    CamerIcDrvHandle_ry_t                      handle,
    CamerIcIspFltDeNoiseLevel_ry_t             *pDeNoiseLevel,
    CamerIcIspFltSharpeningLevel_ry_t          *pSharpeningLevel
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspFltSetFilterParameter_ry
(
    CamerIcDrvHandle_ry_t                      handle,
    const CamerIcIspFltDeNoiseLevel_ry_t       DeNoiseLevel,
    const CamerIcIspFltSharpeningLevel_ry_t    SharpeningLevel
);
...
#endif /* __CAMERIC_ISP_FLT_DRV_RY_API_H__ */
