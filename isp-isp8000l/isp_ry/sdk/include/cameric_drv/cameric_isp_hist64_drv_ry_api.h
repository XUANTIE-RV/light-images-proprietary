...
#ifndef __CAMERIC_ISP_HIST64_DRV_RY_API_H__
#define __CAMERIC_ISP_HIST64_DRV_RY_API_H__

/**
 * @cond    cameric_isp_hist64
 *
 * @file    cameric_isp_hist64_drv_ry_api.h
 *
 ...
 * CamerIcIspHist64SetMeasuringWindow_ry.
 *
 ...
 *
 *****************************************************************************/
typedef uint8_t CamerIcHist64Weights_ry_t[CAMERIC_ISP_HIST64_GRID_ITEMS];
 ...
 *
 *****************************************************************************/
typedef uint32_t CamerIcHist64Bins_ry_t[ CAMERIC_ISP_HIST64_NUM_BINS];
 ...
 *
 *****************************************************************************/
typedef enum CamerIcIspHist64Mode_ry_e
{
...
} CamerIcIspHist64Mode_ry_t;

typedef enum CamerIcIspHist64Channel_ry_e
{
...
typedef struct CamerIcIspHist64Window_ry_s{
	unsigned int offsetX;
	unsigned int offsetY;
	unsigned int width;
	unsigned int height;
}CamerIcIspHist64Window_ry_t;
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspHist64RegisterEventCb_ry
(
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspHist64DeRegisterEventCb_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspHist64Enable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspHist64Disable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspHist64IsEnabled_ry
(
    CamerIcDrvHandle_ry_t      handle,
    bool_t                  *pIsEnabled
);
 ...
 *
 * @param   handle              CamerIc driver handle
 * @param   mode                measurement mode (see @ref CamerIcIspHist64Mode_ry_e)
 *
 * @return                      Return the result of the function call.
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspHist64SetMeasuringMode_ry
(
    CamerIcDrvHandle_ry_t  		handle,
    const CamerIcIspHist64Mode_ry_t	mode
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspHist64SetMeasuringWindow_ry
(
    CamerIcDrvHandle_ry_t  handle,
    const uint16_t      x,
    const uint16_t      y,
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspHist64SetGridWeights_ry
(
    CamerIcDrvHandle_ry_t          handle,
 ...
 *
 *****************************************************************************/
RESULT CamerIcIspHIST64SetSubSampleStep_ry
(
    CamerIcDrvHandle_ry_t          handle,
 ...
 *
 *****************************************************************************/
RESULT CamerIcIspHIST64SetSubSampleRange_ry
(
    CamerIcDrvHandle_ry_t          handle,
    const uint8_t               shift,
 ...
 *
 *****************************************************************************/
RESULT CamerIcIspHIST64FourceUpdate_ry
(
    CamerIcDrvHandle_ry_t          handle
);
 ...
 *
 *****************************************************************************/
RESULT CamerIcIspHist64SetCoeff_ry
(
    CamerIcDrvHandle_ry_t          handle,
    const float               rCoeff,
    const float               gCoeff,
 ...
 *
 *****************************************************************************/
RESULT CamerIcIspHist64SetMeasuringChannel_ry
(
    CamerIcDrvHandle_ry_t          handle,
    const CamerIcIspHist64Channel_ry_t    channel
);
#ifdef __cplusplus
}
#endif
...
#endif /* __CAMERIC_ISP_HIST64_DRV_RY_API_H__ */
