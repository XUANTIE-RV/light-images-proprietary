...
#ifndef __CAMERIC_ISP_AWB_DRV_RY_API_H__
#define __CAMERIC_ISP_AWB_DRV_RY_API_H__

/**
 * @cond    cameric_isp_awb
 *
 * @file    cameric_isp_awb_drv_ry_api.h
 *
 ...
 * in an image processed by the MARVIN. To be able to measure the desired
 ...
 *
 * The following figure shows the position of the AWB module in the CamerIC ISP
 * pipeline.
 *
 * @image html awb.png "Overview of the CamerIC ISP AWB driver" width=\textwidth
 * @image latex awb.png "Overview of the CamerIC ISP AWB driver" width=\textwidth
 *
 */
 ...
 *
 *****************************************************************************/
typedef enum CamerIcIspAwbMeasuringMode_ry_e
{
...
} CamerIcIspAwbMeasuringMode_ry_t;
 ...
 *
 ******************************************************************************/
typedef struct CamerIcAwbMeasuringConfig_ry_s
{
    ...
    uint8_t MinC;           /**< YCbCr Mode: chrominance minimum value, only consider pixels with Cb/Cr each greater than threshold value for WB measurements */
                            /**< RGB Mode  : unused */
} CamerIcAwbMeasuringConfig_ry_t;
 ...
 *
 ******************************************************************************/
typedef struct CamerIcAwbMeasuringResult_ry_s
{
#ifdef ISP_USE_AWBV2
    uint8_t     AwbV2Data[4096]; /**< Y/G  value in YCbCr/RGB Mode */
#else
...
#endif
} CamerIcAwbMeasuringResult_ry_t;
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAwbRegisterEventCb_ry
(
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAwbDeRegisterEventCb_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAwbEnable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAwbDisable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAwbIsEnabled_ry
(
    CamerIcDrvHandle_ry_t      handle,
    bool_t                  *pIsEnabled
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAwbSetMeasuringMode_ry
(
    CamerIcDrvHandle_ry_t                  handle,
    const CamerIcIspAwbMeasuringMode_ry_t  mode,
    const CamerIcAwbMeasuringConfig_ry_t   *pMeasConfig
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAwbSetMeasuringWindow_ry
(
    CamerIcDrvHandle_ry_t  handle,
    const uint16_t      x,
    const uint16_t      y,
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAwbGetGains_ry
(
    CamerIcDrvHandle_ry_t  handle,
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspAwbSetGains_ry
(
    CamerIcDrvHandle_ry_t      handle,
...
/*****************************************************************************/
/**
 * @brief   This functions sets the white balance gains to sensor.
 *
 * @param   handle              CamerIc Sensor driver handle
 * @param   pGains              Pointer to white balance gains to set
 *                              (@ref CamerIcGains_ry_t)
 *
 * @return                      Return the result of the function call.
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcSensorAwbSetGains_ry
(
    IsiSensorHandle_t       handle,
    const CamerIcGains_ry_t    *pGains
);

RESULT CamerIcSensorAwbInit_ry
(
    CamerIcDrvHandle_ry_t      handle,
    IsiSensorHandle_t       hSensor
);
void CamerIcIspAwbV2Signal_ry
(
    CamerIcDrvHandle_ry_t handle
);
#ifdef __cplusplus
...
#endif /* __CAMERIC_ISP_AWB_DRV_RY_API_H__ */
