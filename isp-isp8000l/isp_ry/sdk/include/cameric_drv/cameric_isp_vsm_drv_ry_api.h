...
#ifndef __CAMERIC_ISP_VSM_DRV_RY_API_H__
#define __CAMERIC_ISP_VSM_DRV_RY_API_H__

/**
 * @cond    cameric_isp_vsm
 *
 * @file    cameric_isp_vsm_drv_ry_api.h
 *
 ...
 *
 *****************************************************************************/
typedef struct CamerIcIspVsmEventData_ry_s
{
    uint32_t                frameId;  /**< ID of the frame to which the measured
                                           displacement vector belongs. */
    CamerIcIspVsmDisplVec_ry_t DisplVec; /**< latest calculated displacement vector */
} CamerIcIspVsmEventData_ry_t;
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspVsmRegisterEventCb_ry
(
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspVsmDeRegisterEventCb_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspVsmEnable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspVsmDisable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspVsmIsEnabled_ry
(
    CamerIcDrvHandle_ry_t      handle,
    bool_t                  *pIsEnabled
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspVsmSetMeasuringWindow_ry
(
    CamerIcDrvHandle_ry_t  handle,
    CamerIcWindow_ry_t    *pMeasureWin,
    uint8_t             horSegments,
    uint8_t             verSegments
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspVsmGetMeasuringWindow_ry
(
    CamerIcDrvHandle_ry_t  handle,
    CamerIcWindow_ry_t    *pMeasureWin,
...
#endif /* __CAMERIC_ISP_VSM_DRV_RY_API_H__ */
