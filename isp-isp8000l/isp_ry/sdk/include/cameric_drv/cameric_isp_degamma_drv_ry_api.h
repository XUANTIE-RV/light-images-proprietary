...
#ifndef __CAMERIC_ISP_DEGAMMA_DRV_RY_API_H__
#define __CAMERIC_ISP_DEGAMMA_DRV_RY_API_H__

/**
 * @cond    cameric_isp_degamma
 *
 * @file    cameric_isp_degamma_drv_ry_api.h
 *
 ...
 *
 */
typedef struct CamerIcIspDegammaCurve_ry_s
{
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspDegammaEnable_ry
(
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspDegammaDisable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspDegammaIsEnabled_ry
(
    CamerIcDrvHandle_ry_t  handle,
    bool_t              *pIsEnabled
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspDegammaGetCurve_ry
(
    CamerIcDrvHandle_ry_t          handle,
    CamerIcIspDegammaCurve_ry_t    *pCurve
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspDegammaSetCurve_ry
(
    CamerIcDrvHandle_ry_t          handle,
    CamerIcIspDegammaCurve_ry_t    *pCurve
);
...
#endif /* __CAMERIC_ISP_DEGAMMA_DRV_RY_API_H__ */
