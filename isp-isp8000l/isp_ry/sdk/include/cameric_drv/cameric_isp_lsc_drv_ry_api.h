...
#ifndef __CAMERIC_ISP_LSC_DRV_RY_API_H__
#define __CAMERIC_ISP_LSC_DRV_RY_API_H__

/**
 * @cond    cameric_isp_lsc
 *
 * @file 	cameric_isp_lsc_drv_ry_api.h
 *
 ...
 *
 *****************************************************************************/
typedef struct CamerIcIspLscConfig_ry_s
{
 ...
 *
 *****************************************************************************/
typedef struct CamerIcIspLscSectorConfig_ry_s
{
    uint16_t LscXGradTbl[CAEMRIC_GRAD_TBL_SIZE];    /**< multiplication factors of x direction  */
    uint16_t LscYGradTbl[CAEMRIC_GRAD_TBL_SIZE];    /**< multiplication factors of y direction  */
    uint16_t LscXSizeTbl[CAEMRIC_GRAD_TBL_SIZE];    /**< sector sizes of x direction            */
    uint16_t LscYSizeTbl[CAEMRIC_GRAD_TBL_SIZE];    /**< sector sizes of y direction            */
} CamerIcIspLscSectorConfig_ry_t;
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspLscEnable_ry
(
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspLscDisable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspLscIsEnabled_ry
(
    CamerIcDrvHandle_ry_t      handle,
    bool_t                  *pIsEnabled
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspLscGetLenseShadeCorrection_ry
(
    CamerIcDrvHandle_ry_t              handle,
    CamerIcIspLscConfig_ry_t           *pLscConfig
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspLscSetLenseShadeCorrection_ry
(
    CamerIcDrvHandle_ry_t              handle,
    const CamerIcIspLscConfig_ry_t     *pLscConfig
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspLscGetLenseShadeSectorConfig_ry
(
    CamerIcDrvHandle_ry_t          handle,
    CamerIcIspLscSectorConfig_ry_t *pLscConfig
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspLscSetLenseShadeSectorConfig_ry
(
    CamerIcDrvHandle_ry_t                  handle,
    const CamerIcIspLscSectorConfig_ry_t   *pLscConfig
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspLscSetLenseShadeCorrectionMatrix_ry
(
    CamerIcDrvHandle_ry_t              handle,
...
#endif /* __CAMERIC_ISP_LSC_DRV_RY_API_H__ */
