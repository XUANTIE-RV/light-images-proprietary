...
#ifndef __CAMERIC_ISP_COLOR_ADJUST_DRV_RY_API_H__
#define __CAMERIC_ISP_COLOR_ADJUST_DRV_RY_API_H__

/**
 * @cond    cameric_isp_color_adjust
 *
 * @file    cameric_isp_color_adjust_drv_ry_api.h
 *
...
typedef struct CamerIcIspCa_ry_s
{
    bool enable;
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspCaEnable_ry
(
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspCaDisable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspCaIsEnabled_ry
(
    CamerIcDrvHandle_ry_t      handle,
    bool_t                  *pIsEnabled
);

extern RESULT CamerIcIspCaConfig_ry
(
    CamerIcDrvHandle_ry_t      handle,
    CamerIcIspCa_ry_t  *pCfg
);

extern RESULT CamerIcIspCaGetConfig_ry
(
    CamerIcDrvHandle_ry_t      handle,
    CamerIcIspCa_ry_t *pCfg
);

extern RESULT CamerIcIspUpdateDciCurve_ry
(
    CamerIcDrvHandle_ry_t      handle,
    int *curve
);
...
#endif /* __CAMERIC_ISP_COLOR_ADJUST_DRV_RY_API_H__ */
