...
#ifndef __CAMERIC_JPE_DRV_RY_API_H__
#define __CAMERIC_JPE_DRV_RY_API_H__

/**
 * @cond    cameric_jpe
 *
 * @file    cameric_jpe_drv_ry_api.h
 *
 ...
 *
 *****************************************************************************/
typedef enum CamerIcJpeMode_ry_e
{
 ...
 *
 *****************************************************************************/
typedef enum CamerIcJpeLuminanceScale_ry_e
{
 ...
 *
 *****************************************************************************/
typedef enum CamerIcJpeChrominaceScale_ry_e
{
...
} CamerIcJpeChrominaceScale_ry_t;
 ...
 *
 *****************************************************************************/
typedef enum CamerIcJpeCompressionLevel_ry_e
{
...
} CamerIcJpeCompressionLevel_ry_t;
 ...
 *
 *****************************************************************************/
typedef enum CamerIcJpeHeader_ry_e
{
 ...
 *
 *****************************************************************************/
typedef struct CamerIcJpeConfig_ry_s
{
    CamerIcJpeMode_ry_t                mode;       /**< encoder mode */
    CamerIcJpeCompressionLevel_ry_t    level;      /**< compression level */

    CamerIcJpeLuminanceScale_ry_t      yscale;     /**< luminace upscale mode (BT601 -> full range) */
    CamerIcJpeChrominaceScale_ry_t     cscale;     /**< chrominance upscale mode (BT601 -> full range) */

    uint16_t                        width;      /**< frame width */
    uint16_t                        height;     /**< frame height */
} CamerIcJpeConfig_ry_t;
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcJpeIsEnabled_ry
(
    CamerIcDrvHandle_ry_t      handle,
    bool_t                  *pIsEnabled
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcJpeConfigure_ry
(
    CamerIcDrvHandle_ry_t      handle,
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcJpeRegisterEventCb_ry
(
    CamerIcDrvHandle_ry_t  handle,
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcJpeDeRegisterEventCb_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 * @param   handle              CamerIc driver handle
 * @param   hmode               mode (see @ref CamerIcJpeMode_ry_e)
 *
 * @return                      Return the result of the function call.
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcJpeStartHeaderGeneration_ry
(
    CamerIcDrvHandle_ry_t          handle,
    const CamerIcJpeHeader_ry_t    header
);
 ...
 *
 * @param   handle              CamerIc driver handle
 * @param   mode                mode (see @ref CamerIcJpeMode_ry_e)
 *
 * @return                      Return the result of the function call.
 * @retval  RET_SUCCESS         Configuration successfully applied
 * @retval  RET_OUTOFRANGE      At least one perameter of out range
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcJpeStartEncoding_ry
(
    CamerIcDrvHandle_ry_t      handle,
    const CamerIcJpeMode_ry_t  mode
);
...
#endif /* __CAMERIC_JPE_DRV_RY_API_H__ */
