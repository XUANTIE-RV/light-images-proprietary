...
#ifndef __CAMERIC_ISP_STITCHING_HIST_DRV_RY_API_H__
#define __CAMERIC_ISP_STITCHING_HIST_DRV_RY_API_H__
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspStitchingHistRegisterEventCb_ry
(
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspStitchingHistDeRegisterEventCb_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspStitchingHistEnable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspStitchingHistDisable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspStitchingHistIsEnabled_ry
(
    CamerIcDrvHandle_ry_t      handle,
    bool_t                  *pIsEnabled
);
 ...
 *
 *****************************************************************************/
RESULT CamerIcIspStitchingHistSetMeasuringMode_ry
(
    CamerIcDrvHandle_ry_t          handle,
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspStitchingHistSetMeasuringWindow_ry
(
    CamerIcDrvHandle_ry_t  handle,
    const uint16_t      x,
    const uint16_t      y,
