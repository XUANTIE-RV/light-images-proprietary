...
#ifndef __CAMERIC_MI_DRV_RY_API_H__
#define __CAMERIC_MI_DRV_RY_API_H__

/**
 * @file cameric_mi_drv_ry_api.h
 *
 ...
 *
 *****************************************************************************/
typedef enum CamerIcMiPath_ry_e
{
    CAMERIC_MI_PATH_INVALID_RY         = -1,       /**< lower border (only for an internal evaluation) */
    CAMERIC_MI_PATH_MAIN_RY            =  0,       /**< main path index */
    CAMERIC_MI_PATH_SELF_RY            =  1,       /**< self path index */
    CAMERIC_MI_PATH_SELF2_BP_RY           =  2,       /**< self path index */
#ifdef ISP_MI_MCM_WR_RY
    CAMERIC_MI_PATH_MCM_WR0_RY          ,       /**<mcm wr0 path index */
    CAMERIC_MI_PATH_MCM_WR1_RY          ,       /**<mcm wr1 path index */
#endif
#ifdef ISP_MI_PP_WRITE_RY
    CAMERIC_MI_PATH_POST_PROCESS_RY          ,       /**< post process path index */
#endif
#ifdef ISP_MI_HDR_RY
    CAMERIC_MI_PATH_HDR_L_RY                   ,       /**< mi hdr long path index */
    CAMERIC_MI_PATH_HDR_S_RY                   ,       /**< mi hdr short path index */
    CAMERIC_MI_PATH_HDR_VS_RY                  ,       /**< mi hdr very short path index */
#endif
    CAMERIC_MI_PATH_RDI_RY                     ,       /**< Rdi path index */
    CAMERIC_MI_PATH_META_RY                    ,       /**< Meta path index */
    CAMERIC_MI_PATH_MAX_RY                         /**< upper border (only for an internal evaluation) */
} CamerIcMiPath_ry_t;
 ...
 *
 *****************************************************************************/
typedef enum CamerIcMiDataMode_ry_e
{
    CAMERIC_MI_DATAMODE_INVALID_RY         = 0,    /**< lower border (only for an internal evaluation) */
    CAMERIC_MI_DATAMODE_DISABLED_RY        = 1,    /**< disables the path */
    CAMERIC_MI_DATAMODE_JPEG_RY            = 2,    /**< data output format is JPEG (only valid for mainpath @ref CamerIcMiPath_ry_e) */
    CAMERIC_MI_DATAMODE_YUV444_RY          = 3,    /**< data output format is YUV444 */
    CAMERIC_MI_DATAMODE_YUV422_RY          = 4,    /**< data output format is YUV422 */
    CAMERIC_MI_DATAMODE_YUV420_RY          = 5,    /**< data output format is YUV420 */
    CAMERIC_MI_DATAMODE_YUV400_RY          = 6,    /**< data output format is YUV400 */
    CAMERIC_MI_DATAMODE_RGB888_RY          = 7,    /**< data output format is RGB888 (only valid for selpath @ref CamerIcMiPath_ry_e) */
    CAMERIC_MI_DATAMODE_RGB666_RY          = 8,    /**< data output format is RGB666 (only valid for selpath @ref CamerIcMiPath_ry_e) */
    CAMERIC_MI_DATAMODE_RGB565_RY          = 9,    /**< data output format is RGB565 (only valid for selpath @ref CamerIcMiPath_ry_e) */
    CAMERIC_MI_DATAMODE_RAW8_RY            = 10,   /**< data output format is RAW8 (only valid for mainpath @ref CamerIcMiPath_ry_e) */
    CAMERIC_MI_DATAMODE_RAW12_RY           = 11,   /**< data output format is RAW12 (only valid for mainpath @ref CamerIcMiPath_ry_e) */
    CAMERIC_MI_DATAMODE_DPCC_RY            = 12,   /**< path dumps out the current measured defect pixel table */
    CAMERIC_MI_DATAMODE_RAW10_RY           = 13,   /**< data output format is RAW10 (only valid for mainpath @ref CamerIcMiPath_ry_e) */
    CAMERIC_MI_DATAMODE_RAW14_RY           = 14,   /**< data output format is RAW14 (only valid for mainpath @ref CamerIcMiPath_ry_e) */
    CAMERIC_MI_DATAMODE_RAW16_RY           = 15,   /**< data output format is RAW16 (only valid for mainpath @ref CamerIcMiPath_ry_e) */
    CAMERIC_MI_DATAMODE_META_RY            = 16,   /**< data output format is META (only valid for metapath @ref CamerIcMiPath_ry_e) */
    CAMERIC_MI_DATAMODE_MAX_RY                     /**< upper border (only for an internal evaluation) */
} CamerIcMiDataMode_ry_t;
 ...
 *          CAMERIC_MI_DATASTORAGE_INVALID_RY to CAMERIC_MI_DATASTORAGE_MAX_RY.
 *
 *****************************************************************************/
typedef enum CamerIcMiDataLayout_ry_e
{
    CAMERIC_MI_DATASTORAGE_INVALID_RY      = 0,    /**< lower border (only for an internal evaluation) */
    CAMERIC_MI_DATASTORAGE_PLANAR_RY       = 1,    /**< YUV values are packed together as: YYYY......, UVUVUVUV...... */
    CAMERIC_MI_DATASTORAGE_SEMIPLANAR_RY   = 2,    /**< YUV values are packed together as: YUV, YUV, YUV, ...... */
    CAMERIC_MI_DATASTORAGE_INTERLEAVED_RY  = 3,    /**< Y values for all pixels are put together, as well as U and V,
                                                     like: YYYYYY......, UUUUUUU......., VVVVVV...... */
    CAMERIC_MI_DATASTORAGE_MAX_RY                  /**< upper border (only for an internal evaluation) */
} CamerIcMiDataLayout_ry_t;
 ...
 *
 *****************************************************************************/
typedef enum CamerIcMiDataAlignMode_ry_e
{
    CAMERIC_MI_PIXEL_ALIGN_INVALID_RY      = -1,    /**< lower border (only for an internal evaluation) */
    CAMERIC_MI_PIXEL_UN_ALIGN_RY       = 0,    /**< The value of pixel is not align. */
    CAMERIC_MI_PIXEL_ALIGN_12BIT_RY   = 1,    /**< The value of pixel is align with 128 bit.*/
    CAMERIC_MI_PIXEL_ALIGN_16BIT_RY  = 2,    /**< The value of pixel is align with 16bit.*/
    CAMERIC_MI_PIXEL_ALIGN_MAX_RY            /**< upper border (only for an internal evaluation) */
} CamerIcMiDataAlignMode_ry_t;
 ...
 *
 *****************************************************************************/
typedef enum CamerIcMiBurstLength_ry_e
{
    CAMERIC_MI_BURSTLENGTH_INVALID_RY        = 0,    /**< lower border (only for an internal evaluation) */
    CAMERIC_MI_BURSTLENGTH_4_RY            = 1,    /**< burstlength of 4 or smaller */
    CAMERIC_MI_BURSTLENGTH_8_RY            = 2,    /**< burstlength of 8 or smaller */
    CAMERIC_MI_BURSTLENGTH_16_RY           = 3,    /**< burstlength of 16 or smaller */
    CAMERIC_MI_BURSTLENGTH_MAX_RY                  /**< upper border (only for an internal evaluation) */
} CamerIcMiBurstLength_ry_t;
 ...
 *
 *****************************************************************************/
typedef enum CamerIcMiMpOutputFifoDepth_ry_e
{
...
}CamerIcMiMpOutputFifoDepth_ry_t;
#endif
 ...
 *
 *****************************************************************************/
typedef enum CamerIcMiMpOutputLsbAlign_ry_e
{
...
}CamerIcMiMpOutputLsbAlign_ry_t;
#endif
 ...
 *
 *****************************************************************************/
typedef enum CamerIcMiMpOutputByteSwap_ry_e
{
...
}CamerIcMiMpOutputByteSwap_ry_t;
#endif
 ...
 *
 *****************************************************************************/
typedef enum CamerIcMiMpHandshakeSwitch_ry_e
{
...
}CamerIcMiMpHandshakeSwitch_ry_t;
 ...
 *
 *****************************************************************************/
typedef enum CamerIcMiMpHandshakeStorageFormat_ry_e
{
...
}CamerIcMiMpHandshakeStorageFormat_ry_t;
 ...
 *
 *****************************************************************************/
typedef enum CamerIcMiMpHandshakeDataFormat_ry_e
{
...
}CamerIcMiMpHandshakeDataFormat_ry_t;
 ...
 *
 *****************************************************************************/
typedef struct CamerIcMiMpHandshake_ry_s{
    CamerIcMiMpHandshakeSwitch_ry_t              handshk_switch;
    CamerIcMiMpHandshakeStorageFormat_ry_t       storage_fmt;
    CamerIcMiMpHandshakeDataFormat_ry_t          data_fmt;
...
typedef struct CamerIcCmpPrm_ry_s{
    char*  dstFileName;
}CamerIcCmpPrm_ry_t;
//#endif
#endif
...
typedef enum  CamerIcMiOrientation_ry_e
{
    CAMERIC_MI_ORIENTATION_INVALID_RY          = 0,    /**< lower border (only for an internal evaluation) */
    CAMERIC_MI_ORIENTATION_ORIGINAL_RY         = 1,    /**< no rotation, no horizontal or vertical flipping */
    CAMERIC_MI_ORIENTATION_VERTICAL_FLIP_RY    = 2,    /**< vertical   flipping (no additional rotation) */
    CAMERIC_MI_ORIENTATION_HORIZONTAL_FLIP_RY  = 3,    /**< horizontal flipping (no additional rotation) */
    CAMERIC_MI_ORIENTATION_ROTATE90_RY         = 4,    /**< rotation  90 degrees ccw (no additional flipping) */
    CAMERIC_MI_ORIENTATION_ROTATE180_RY        = 5,    /**< rotation 180 degrees ccw (equal to horizontal plus vertical flipping) */
    CAMERIC_MI_ORIENTATION_ROTATE270_RY        = 6,    /**< rotation 270 degrees ccw (no additional flipping) */
    ...
    CAMERIC_MI_ORIENTATION_MAX_RY                      /**< upper border (only for an internal evaluation) */
} CamerIcMiOrientation_ry_t;
 ...
 *          buffer to fill, please also see @ref CamerIcRequestId_ry_e).
 *
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcMiRegisterRequestCb_ry
(
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcMiDeRegisterRequestCb_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *          or an error situation (i.e. please also see @ref CamerIcEventId_ry_e).
 *
 * @param   handle              CamerIc driver handle
 * @param   func                Callback function
 * @param   pUserContext        User-Context
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcMiRegisterEventCb_ry
(
    CamerIcDrvHandle_ry_t  handle,
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcMiDeRegisterEventCb_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcMiSetBurstLength_ry
(
    CamerIcDrvHandle_ry_t              handle,
    const CamerIcMiBurstLength_ry_t    y_burstlength,
    const CamerIcMiBurstLength_ry_t    c_burstlength
);
 ...
 *
 * @param   handle              CamerIc driver handle
 * @param   path                Path index of CamerIC (@ref CamerIcMiPath_ry_e)
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcMiSetResolution_ry
(
    CamerIcDrvHandle_ry_t          handle,
    const CamerIcMiPath_ry_t       path,
 ...
 * @param   handle              CamerIc driver handle
 * @param   path                Path index of CamerIC (@ref CamerIcMiPath_ry_e)
 * @param   mode                Data output mode (@ref CamerIcMiDataMode_ry_e)
 *
 * @return                      Return the result of the function call.
 * @retval  RET_SUCCESS         operation succeded
 * @retval  RET_FAILURE         common error occured
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcMiSetDataMode_ry
(
    CamerIcDrvHandle_ry_t          handle,
    const CamerIcMiPath_ry_t       path,
    const CamerIcMiDataMode_ry_t   mode
);
 ...
 * @param   handle              CamerIc driver handle
 * @param   path                Path index of CamerIC (@ref CamerIcMiPath_ry_e)
 * @param   alignMode           Data output align mode (@ref CamerIcMiDataAlignMode_ry_e)
 *
 * @return                      Return the result of the function call.
 * @retval  RET_SUCCESS         operation succeded
 * @retval  RET_FAILURE         common error occured
...
extern RESULT CamerIcMiSetDataAlignMode_ry
(
    CamerIcDrvHandle_ry_t          handle,
    const CamerIcMiPath_ry_t       path,
    const CamerIcMiDataAlignMode_ry_t alignMode
);
...
extern RESULT CamerIcMiSetDataYUVMode_ry
(
    CamerIcDrvHandle_ry_t          handle,
    const CamerIcMiPath_ry_t       path,
 ...
 *
 *****************************************************************************/
RESULT CamerIcMiMpOutputFifoDepthRegRead_ry
(
    CamerIcDrvHandle_ry_t handle,
 ...
 * @param   handle              CamerIc driver handle
 * @param   path                Path index of CamerIC (@ref CamerIcMiPath_ry_e)
 * @param   depth               Fifo depth mode (@ref CamerIcMiMpOutputFifoDepth_ry_t)
 *
 * @return                      Return the result of the function call.
 * @retval  RET_SUCCESS         operation succeded
 * @retval  RET_FAILURE         common error occured
 ...
 *
 *****************************************************************************/
RESULT CamerIcMiMpOutputFifoSetDepth_ry
(
    CamerIcDrvHandle_ry_t                   handle,
    const CamerIcMiPath_ry_t                path,
    const CamerIcMiMpOutputFifoDepth_ry_t   depth
);
#endif
 ...
 * @param   handle              CamerIc driver handle
 * @param   path                Path index of CamerIC (@ref CamerIcMiPath_ry_e)
 * @param   align               lsb align cfg(@ref CamerIcMiMpOutputLsbAlign_ry_t)
 * @param   swap                byte swap set(@ref CamerIcMiMpOutputByteSwap_ry_t)
 *
 * @return                      Return the result of the function call.
 * @retval  RET_SUCCESS         operation succeded
 * @retval  RET_FAILURE         common error occured
 ...
 *
 *****************************************************************************/
RESULT CamerIcMiMpAlignSetCfg_ry
(
    CamerIcDrvHandle_ry_t                   handle,
    const CamerIcMiPath_ry_t                path,
    const CamerIcMiMpOutputLsbAlign_ry_t    align,
    const CamerIcMiMpOutputByteSwap_ry_t    swap
);
#endif
 ...
 * @param   handle              CamerIc driver handle
 * @param   path                Path index of CamerIC (@ref CamerIcMiPath_ry_e)
 * @param   *handshk_cfg        point to handshake configuration(@ref CamerIcMiMpHandshake_ry_t)
 *
 * @return                      Return the result of the function call.
 * @retval  RET_SUCCESS         operation succeded
 * @retval  RET_FAILURE         common error occured
 ...
 *
 *****************************************************************************/
RESULT CamerIcMiHandshakeSetCfg_ry
(
    CamerIcDrvHandle_ry_t                   handle,
    const CamerIcMiPath_ry_t                path,
    const CamerIcMiMpHandshake_ry_t         *handshk_cfg
);
 ...
 *
 * @param   hCamEngine          handle to the CamerIcDrvHandle_ry_t instance
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcMiDumpBufCfg_ry
(
    CamerIcDrvHandle_ry_t       hCamerIcDrv,
    const CamerIcMiPath_ry_t   path,
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcMiDumpToFile_ry
(
    CamerIcDrvHandle_ry_t       hCamerIcDrv,
    const CamerIcMiPath_ry_t   path
);
 ...
 * @param   hCamEngine          handle to the CamerIcDrvHandle_ry_t instance
 * @param   path                MI path cfg
 * @param   CamerIcCmpPrm_ry_t     compress parm
 *
 * @return  Return the result of the function call.
 * @retval  RET_SUCCESS         function succeed
 * @retval  RET_WRONG_HANDLE    invalid instance handle
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcMiCompressToFile_ry
(
    CamerIcDrvHandle_ry_t       hCamerIcDrv,
    const CamerIcMiPath_ry_t    path,
    const CamerIcCmpPrm_ry_t  *pParm
);
//#endif
#endif
 ...
 * @param   handle              CamerIc driver handle
 * @param   path                Path index of CamerIC (@ref CamerIcMiPath_ry_e)
 * @param   layout              Data layout (@ref CamerIcMiDataLayout_ry_e)
 *
 * @return                      Return the result of the function call.
 * @retval  RET_SUCCESS         operation succeded
 * @retval  RET_FAILURE         common error occured
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcMiSetDataLayout_ry
(
    CamerIcDrvHandle_ry_t          handle,
    const CamerIcMiPath_ry_t       path,
    const CamerIcMiDataLayout_ry_t layout
);
 ...
 *
 * @param   handle              CamerIc driver handle
 * @param   orientation         Picture orientation (@ref CamerIcMiDataLayout_ry_e)
 *
 * @return                      Return the result of the function call.
 * @retval  RET_SUCCESS         operation succeded
 * @retval  RET_FAILURE         common error occured
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcMiSetPictureOrientation_ry
(
    CamerIcDrvHandle_ry_t              handle,
    const CamerIcMiPath_ry_t           path,
    const CamerIcMiOrientation_ry_t    orientation
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcMiSetFramesToSkip_ry
(
    CamerIcDrvHandle_ry_t              handle,
 ...
 *
 *****************************************************************************/
RESULT CamerIcMiSetPpwLineNum_ry(CamerIcDrvHandle_ry_t handle, uint16_t num);
 ...
 *
 *****************************************************************************/
RESULT CamerIcMiGetPpwLineCnt_ry(CamerIcDrvHandle_ry_t handle, uint16_t *pCnt);
RESULT CamerIcMiGetPpwBufInfo_ry(CamerIcDrvHandle_ry_t handle, pp_write_line_entry_ry_t *pp_wr_line_entry);
#endif
 ...
 *
 *****************************************************************************/
RESULT CamerIcMiCfgPpDmaLineEntry_ry(CamerIcDrvHandle_ry_t handle, uint16_t bufNum, uint16_t lineNum, uint64_t bufAddr);
#endif
#ifdef __cplusplus
}
#endif
...
#endif /* __CAMERIC_MI_DRV_RY_API_H__ */
