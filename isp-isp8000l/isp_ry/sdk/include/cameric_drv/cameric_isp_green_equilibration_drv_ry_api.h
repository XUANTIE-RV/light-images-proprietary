...
#ifndef __CAMERIC_ISP_GREEN_EQUILIBRATION_DRV_RY_API_H__
#define __CAMERIC_ISP_GREEN_EQUILIBRATION_DRV_RY_API_H__

/**
 * @cond    cameric_isp_green_equilibration
 *
 * @file    cameric_isp_green_equilibration_drv_ry_api.h
 *
...
typedef struct CamerIcIspGreenEqlr_ry_s
{
    bool enable;
    uint16_t threshold;
    uint16_t dummyLine;
} CamerIcIspGreenEqlr_ry_t;
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspGreenEqlrEnable_ry
(
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspGreenEqlrDisable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcIspGreenEqlrIsEnabled_ry
(
    CamerIcDrvHandle_ry_t      handle,
    bool_t                  *pIsEnabled
);
 ...
 *
 *****************************************************************************/
RESULT CamerIcIspGreenEqlrConfig_ry
(
    CamerIcDrvHandle_ry_t      handle,
    uint16_t threshold, uint16_t dummyLine
);

RESULT CamerIcIspGetGe_ry
(
    CamerIcDrvHandle_ry_t  handle,
    uint32_t            *enable,
    uint32_t            *pThreshold,
...
#endif /* __CAMERIC_ISP_GREEN_EQUILIBRATION_DRV_RY_API_H__ */
