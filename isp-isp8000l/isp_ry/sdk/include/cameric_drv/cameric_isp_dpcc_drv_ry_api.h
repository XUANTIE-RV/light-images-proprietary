...
#ifndef __CAMERIC_ISP_DPCC_DRV_RY_API_H__
#define __CAMERIC_ISP_DPCC_DRV_RY_API_H__

/**
 * @file    cameric_isp_dpcc_drv_ry_api.h
 *
 ...
 */
/*****************************************************************************/
typedef struct CamerIcDpccStaticConfig_ry_s
{
 ...
 *
 *****************************************************************************/
RESULT CamerIcIspDpccEnable_ry
(
 ...
 *
 *****************************************************************************/
RESULT CamerIcIspDpccDisable_ry
(
    CamerIcDrvHandle_ry_t handle
);
 ...
 *
 *****************************************************************************/
RESULT CamerIcIspDpccSetStaticConfig_ry
(
    CamerIcDrvHandle_ry_t          handle,
    CamerIcDpccStaticConfig_ry_t   *pConfig
);
...
#endif /* __CAMERIC_ISP_DPCC_DRV_RY_API_H__ */
