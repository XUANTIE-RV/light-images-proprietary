...
#ifndef __CAM_ENGINE_AAA_RY_API_H__
#define __CAM_ENGINE_AAA_RY_API_H__
...
RESULT CamEngineSetMode_ry(CamEngineHandle_ry_t hCamEngine, int moduleName, uint8_t mode);
RESULT CamEngineGetMode_ry(CamEngineHandle_ry_t hCamEngine, int moduleName, uint8_t *mode);
...
(
    CamEngineHandle_ry_t           hCamEngine,     /**< handle CamEngine */
...
(
    CamEngineHandle_ry_t 			hCamEngine,
    const CamEngineA2dnrMode_ry_t  mode           /**< run-mode */
);
...
(
    CamEngineHandle_ry_t   	hCamEngine,
    bool_t              	*pRunning,
    CamEngineA2dnrMode_ry_t  	*pMode,				/**< run-mode */
    float					*pGain,				/**< gain */
 ...
 *
 *****************************************************************************/
RESULT CamEngineAtdnrConfigure_ry
(
    CamEngineHandle_ry_t                hCamEngine,        /**< handle CamEngine */
    const CamEngineTdnrConfig_ry_t      *pTdnrConfig    /**< point of tdnrConfig */
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAtdnrSetAutoStrength_ry
(
    CamEngineHandle_ry_t        hCamEngine,     /**< handle CamEngine */
 ...
 *
 *****************************************************************************/
RESULT CamEngineAtdnrSetAutoTable_ry
(
    CamEngineHandle_ry_t                    hCamEngine,         /**< handle CamEngine */
    const CamEngineAtdnrParamNode_ry_t     *pParamNodeTable,    /**< CamEngineA3dnrParamNode_t */
    const uint8_t                        nodeNum             /**< nodeNum */
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAtdnrStatus_ry
(
    CamEngineHandle_ry_t                hCamEngine,
    bool_t                            *pRunning,
    CamEngineAtdnrMode_ry_t            *pMode,             /**< run-mode */
    CamEngineAtdnrParamNode_ry_t         *pCurrentStatus
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineA2dnrV5Start_ry
(
    CamEngineHandle_ry_t            hCamEngine,
    const CamEngineA2dnrMode_ry_t    mode           /**< run-mode */
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineA2dnrV5Stop_ry
(
    CamEngineHandle_ry_t hCamEngine
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineA2dnrV5Configure_ry
(
    CamEngineHandle_ry_t            hCamEngine,                    /**< handle CamEngine */
 ...
 *
 *****************************************************************************/
RESULT CamEngineA2dnrV5SetAutoTable_ry
(
    CamEngineHandle_ry_t                     hCamEngine,         /**< handle CamEngine */
    const CamEngineA2dnrV5ParamNode_ry_t     *pParamNodeTable,    /**< CamEngineA2dnrV5ParamNode_t */
    const uint8_t                          nodeNum             /**< nodeNum */
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineA2dnrV5Status_ry
(
    CamEngineHandle_ry_t                hCamEngine,
    bool_t                           *pRunning,
    CamEngineA2dnrMode_ry_t             *pMode,
    CamEngineA2dnrV5ParamNode_ry_t      *pCurrentStatus
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAhdrV12Start_ry
(
    CamEngineHandle_ry_t            hCamEngine,
    const CamEngineAhdrMode_ry_t    mode           /**< run-mode */
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAhdrV12Stop_ry
(
    CamEngineHandle_ry_t hCamEngine
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAhdrV12Configure_ry
(
    CamEngineHandle_ry_t                hCamEngine,     /**< handle CamEngine */
    const CamEngineHdrConfig_ry_t         *pHdrConfig        /**< point of hdrConfig */
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAhdrV12SetAutoTable_ry
(
    CamEngineHandle_ry_t                    hCamEngine,         /**< handle CamEngine */
    const CamEngineAhdrParamNode_ry_t         *pParamNodeTable,    /**< CamEngineAhdrParamNode_t */
    const uint8_t                        nodeNum             /**< nodeNum */
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAhdrV12Status_ry
(
    CamEngineHandle_ry_t        hCamEngine,
    CamEngineHdrStatus_ry_t    *pCurrentStatus
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAhdrV12GetConfig_ry
(
    CamEngineHandle_ry_t        hCamEngine,
    CamEngineHdrConfig_ry_t    *pConfig
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAhdrV12GetDolType_ry
(
    CamEngineHandle_ry_t        hCamEngine,
    CamEngineHdrDolType_ry_t    *pDolType            /**< Dol type */
);
#endif
 ...
 *
 *****************************************************************************/
RESULT CamEngineWdr4Configure_ry
(
    CamEngineHandle_ry_t                hCamEngine,      /**< handle CamEngine */
    const CamEngineWdr4Config_ry_t        *pWdr4Config
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineWdr4SetAutoTable_ry
(
    CamEngineHandle_ry_t                    hCamEngine,         /**< handle CamEngine */
    const CamEngineAwdr4ParamNode_ry_t     *pParamNodeTable,    /**< CamEngineAwdr4ParamNode_t */
    const uint8_t                        nodeNum             /**< nodeNum */
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineWdr4GetStatus_ry
(
    CamEngineHandle_ry_t hCamEngine,
    bool_t *pRunning,
    uint8_t *pMode, /**< run-mode */
    CamEngineAwdr4ParamNode_ry_t *pCurrentStatus
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAcaStart_ry
(
    CamEngineHandle_ry_t            hCamEngine,
    const CamEngineAcaMode_ry_t    mode           /**< run-mode */
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAcaConfigure_ry
(
    CamEngineHandle_ry_t                hCamEngine,      /**< handle CamEngine */
    const CamEngineCaConfig_ry_t         *pCaConfig
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAcaSetAutoTable_ry
(
    CamEngineHandle_ry_t                    hCamEngine,         /**< handle CamEngine */
    const CamEngineAcaParamNode_ry_t         *pParamNodeTable,    /**< CamEngineAcaParamNode_t */
    const uint8_t                        nodeNum             /**< nodeNum */
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAcaStatus_ry
(
    CamEngineHandle_ry_t            hCamEngine,
    bool_t                        *pRunning,
    CamEngineAcaMode_ry_t            *pMode,             /**< run-mode */
    CamEngineAcaStatus_ry_t        *pCurrentStatus
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAdciStart_ry
(
    CamEngineHandle_ry_t            hCamEngine,
    const CamEngineAdciMode_ry_t    mode           /**< run-mode */
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAdciConfigure_ry
(
    CamEngineHandle_ry_t                hCamEngine,      /**< handle CamEngine */
    const CamEngineDciConfig_ry_t        *pDciConfig
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAdciSetAutoTable_ry
(
    CamEngineHandle_ry_t                    hCamEngine,         /**< handle CamEngine */
    const CamEngineAdciParamNode_ry_t        *pParamNodeTable,    /**< CamEngineAdciParamNode_t */
    const uint8_t                        nodeNum             /**< nodeNum */
);
 ...
 *
 *****************************************************************************/
RESULT CamEngineAdciStatus_ry
(
    CamEngineHandle_ry_t            hCamEngine,
    bool_t                        *pRunning,
    CamEngineAdciMode_ry_t            *pMode,             /**< run-mode */
    CamEngineAdciStatus_ry_t        *pCurrentStatus
);
...
(
    CamEngineHandle_ry_t   hCamEngine,
    bool_t              *pRunning,
    CamEngineVector_ry_t   *pCurrDisplVec,
    CamEngineVector_ry_t   *pCurrOffsetVec
);

// read aev2 data, size: 4096
// will handle 16bit in 3a, and pass 8 bit to client
RESULT CamEngineAev2GetData(CamEngineHandle_ry_t hCamEngine,uint8_t *data);
// read aehdr data
// ae data size: 75,  L/S/VS
// hist size: 48, L/S/VS
// will handle 16bit in 3a, and pass 8 bit to client
RESULT CamEngineAehdrGetData(CamEngineHandle_ry_t hCamEngine, uint8_t *aeData, uint32_t *histData);
// read hist256 data, size: 256
RESULT CamEngineHist256GetData(CamEngineHandle_ry_t hCamEngine, uint32_t *histData);
// read hist64 data, size: 32
RESULT CamEngineHist64GetData(CamEngineHandle_ry_t hCamEngine, uint32_t *histData);
// read hist16 data, size: 16
RESULT CamEngineHist16GetData(CamEngineHandle_ry_t hCamEngine, uint32_t *histData);
// read curve of dci hist mode, refresh every frame, size: 65
RESULT CamEngineGetDciHistCurve(CamEngineHandle_ry_t hCamEngine, uint16_t *curve);
...
#endif /* __CAM_ENGINE_AAA_RY_API_H__ */
