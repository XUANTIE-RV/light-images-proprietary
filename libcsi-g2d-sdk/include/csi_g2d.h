...
typedef enum _csi_g2d_pool {
    CSI_G2D_POOL_DEFAULT,
    CSI_G2D_POOL_USER,
} csi_g2d_pool;
...
int csi_g2d_surface_import(csi_g2d_surface *csi_surface, int fd);
int csi_g2d_surface_export(csi_g2d_surface *csi_surface, int *fd);
